...
function Page() {
      ...
      const paymentOptions = {
        ...
        handler: async function (response: any) {
          ...
          startTransition(async () => {
            ...
            if (!res1.success)
              toast.error(res1.error || "Failed to book appointment.");
            else {
  ...
  return (
    <>
      <Head>
        <title>
          Book an Appointment | Upasna Homoeo - Compassionate Homeopathic Care
        </title>
        <meta
          name="description"
          content="Schedule your appointment with Dr. Alok Verma at Upasna Homoeo Clinic, Ajmer. Receive personalized homeopathic treatments for chronic and lifestyle conditions."
        />
        <meta
          name="keywords"
          content="book appointment, Upasna Homoeo, Dr. Alok Verma, homeopathy consultation, chronic illness treatment, natural healing Ajmer, holistic care"
        />
        <meta name="author" content="Upasna Homoeo Clinic" />
        {/* Open Graph (Facebook, LinkedIn) */}
        <meta
          property="og:title"
          content="Book Your Consultation | Upasna Homoeo - Expert Homeopathy in Ajmer"
        />
        <meta
          property="og:description"
          content="Easily book a consultation with Dr. Alok Verma. Experience personalized, effective homeopathic care trusted by over 200,000 patients."
        />
        <meta
          property="og:image"
          content="https://www.upasanahomoeo.com/images/upasna-book.jpg"
        />{" "}
        {/* Replace with actual image URL */}
        <meta
          property="og:url"
          content="https://www.upasanahomoeo.com/book-appointment"
        />
        ...
        <meta
          name="twitter:title"
          content="Book Your Appointment | Upasna Homoeo - Trusted Homeopathy Clinic"
        />
        <meta
          name="twitter:description"
          content="Secure your appointment with Dr. Alok Verma and start your journey to natural healing with Upasna Homoeo."
        />
        <meta
          name="twitter:image"
          content="https://www.upasanahomoeo.com/images/upasna-book.jpg"
              ...
              >
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    <p>
                      Please proceed with the payment to book your appoinment
                    </p>
                  </div>
                  ...
                  <div className="flex space-y-2 flex-col md:flex-row justify-center items-center space-x-4">
                    <input
                      ...
                      onChange={(e) => setPromoCode(e.target.value)} // Assuming setPromoCode updates state for promo code
                    />
