  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Get in touch with Afecto Homeopathy Clinic for online consultations, appointments, and visit our clinics in Delhi and Mumbai."
        />
