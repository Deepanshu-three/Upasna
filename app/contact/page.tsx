...
const ContactPage = () => {
  return (
    <>
      {/* SEO Meta Tags */}
      <Head>
        <title>Contact Us | Upasna Homoeo - Trusted Homeopathy Clinic</title>
        <meta
          name="description"
          content="Reach out to Upasna Homoeo Clinic for appointments, online consultations, or general inquiries. Serving Ajmer with expert homeopathic care."
        />
        ...
        <meta
          property="og:title"
          content="Contact Upasna Homoeo | Book Consultations & Appointments"
        />
        <meta
          property="og:description"
          content="Get in touch with Upasna Homoeo Clinic, Ajmer for expert homeopathic treatments and personalized care. We’re here to help you on your healing journey."
        />
        <meta
          property="og:url"
          content="https://www.upasanahomoeo.com/contact"
        />
        <meta
          property="og:image"
          content="https://www.upasanahomoeo.com/images/contact-og.jpg"
        />
        ...
        <meta
          name="twitter:title"
          content="Contact Upasna Homoeo | Trusted Homeopathy Clinic in Ajmer"
        />
        <meta
          name="twitter:description"
          content="Contact Upasna Homoeo Clinic for appointments, consultations, and support. Your path to natural healing starts here."
        />
        <meta
          name="twitter:image"
          content="https://www.upasanahomoeo.com/images/contact-og.jpg"
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-10">
              ...
              <div className="w-full md:w-1/2 flex flex-col gap-4 items-center">
                ...
                <address className="text-center mb-6">
                  Bihari Ganj, Ajmer, India 305001
                </address>
                <iframe
              ...
              <div className="w-full md:w-1/2 flex flex-col gap-4 items-center">
                ...
                <address className="text-center">
                  Shop no.4, 364/46, Gandhi Nagar Rd, Naka Madar Colony, Gandhi
                  Nagar, Ajmer, India 305001
                </address>
                <iframe
